...
// Read theme files - use JSON files directly to avoid import issues
const lightTheme = JSON.parse(fs.readFileSync(path.join(__dirname, '../src/theme/themes/light.json'), 'utf8'));
const darkTheme = JSON.parse(fs.readFileSync(path.join(__dirname, '../src/theme/themes/dark.json'), 'utf8'));
const amoledTheme = JSON.parse(fs.readFileSync(path.join(__dirname, '../src/theme/themes/amoled.json'), 'utf8'));
const highContrastTheme = JSON.parse(fs.readFileSync(path.join(__dirname, '../src/theme/themes/highContrast.json'), 'utf8'));
